...
export function deleteSceneImage(sceneId: string, scene_imageId: string) {
  console.log("Solicitando exclusão de imagem da cena com id: ", scene_imageId);
  socket.emit('deleteSceneImage', {sceneId, scene_imageId});
}
